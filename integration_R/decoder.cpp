...
namespace poseidon16
{
    ...
    ReadyInstruction Decoder::read_operands(const DecodedInstruction &decoded, const RegFile &regs) // no need for reference on regs
    {
        ...
        switch (decoded.opcode)
        {
            ...
            default:
                throw std::invalid_argument("read_operands: unknown opcode");
        }
